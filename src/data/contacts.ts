...
export const leadership: Person[] = [
  {
    ...
    nameZh: '王泽军',
    role: {
      ru: 'Председатель правления группы компаний «ПОРТ»',
      en: 'Chairman of the Board, PORT group of companies',
      zh: '满洲里口岸集团董事长',
    },
  ...
  },
  {
    ...
    nameZh: '杨继燕',
    role: {
      ru: 'Исполнительный вице-президент группы компаний «ПОРТ», генеральный директор терминала',
      en: 'Executive Vice-President of the PORT group, Terminal General Director',
      zh: '满洲里口岸集团常务副总裁，场地总经理',
    },
